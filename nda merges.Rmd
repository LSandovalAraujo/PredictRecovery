...
```{r}
write.csv(fullMorningSurvey, "C:/Users/Luis/Box/R15 Sensor Preprocessing and Analysis/NDA/Ethica Morning Surveys.csv", row.names = FALSE)
```
...
fullafternoonSurvey
write.csv(fullafternoonSurvey, "C:/Users/Luis/Box/R15 Sensor Preprocessing and Analysis/NDA/Ethica Afternoon Surveys.csv", row.names = FALSE)
```
...
fulleveningSurvey
write.csv(fulleveningSurvey, "C:/Users/Luis/Box/R15 Sensor Preprocessing and Analysis/NDA/Ethica Evening Surveys.csv", row.names = FALSE)
```
